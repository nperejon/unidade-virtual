...
export default {
    ...
    methods: {
        loadArticles() {
            const url = `${baseApiUrl}/artigos?page=${this.page}`
        ...
        save() {
            ...
            axios[method](`${baseApiUrl}/artigos${id}`, this.article)
                .then(() => {
        ...
        remove() {
            ...
            axios.delete(`${baseApiUrl}/artigos/${id}`)
                .then(() => {
                    this.$toasted.global.defaultSuccess()
                    this.reset()
                })
        ...
        loadArticle(article, mode = 'save') {
            this.mode = mode
            axios.get(`${baseApiUrl}/artigos/${article.id}`)
